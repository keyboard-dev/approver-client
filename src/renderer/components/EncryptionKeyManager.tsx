      ...
      <div className="space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div className="text-sm text-blue-700 space-y-1">
            <p>• <strong>Environment Variable:</strong> ENCRYPTION_KEY takes highest priority</p>
            <p>• <strong>Generated Key:</strong> Used when no environment variable is set</p>
            <p>• <strong>Security:</strong> All keys are 32-byte AES-256 keys</p>
            <p>• <strong>Storage:</strong> Generated keys are stored securely on your local machine</p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center pt-4 border-t">
          <div className="text-sm text-gray-500">
            ...
            {keyInfo.source === 'environment' && (
              <>Using environment variable: <code className="text-xs">ENCRYPTION_KEY</code></>
            )}
          </div>
          <Button
            variant="outline"
