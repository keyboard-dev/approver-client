...
class MenuBarNotificationApp {
  ...
  private initializeApp(): void {
    ...
    app.whenReady().then(async () => {
      ...
      this.initializeAutoUpdaterService()
  ...
  private initializeAutoUpdaterService(): void {
    const isDev = process.argv.includes('--dev') || !app.isPackaged
    if (!isDev) {
      this.autoUpdaterService = new AutoUpdaterService(this.windowManager)
      this.autoUpdaterService.initialize()
      this.autoUpdaterService.setupIPCHandlers()
    }
  }
      ...
      template.push({
        ...
        submenu: [
          ...
          { type: 'separator' },
          {
            ...
            click: () => this.autoUpdaterService?.checkForUpdates(),
          },
          {
            label: 'Install Update',
            click: () => this.autoUpdaterService?.quitAndInstall(),
          },
          { type: 'separator' },
